...
daily_fort_solgress = MultiVision("dailies\\daily_fort_solgress.png", 'dailies\\daily_fort_solgress_new.png', image_name='daily_fort_solgress')
daily_friendship_coins = MultiVision("dailies\\daily_friendship_coins.png", 'dailies\\daily_friendship_coins_new.png', image_name='daily_friendship_coins')
daily_patrol = MultiVision("dailies\\daily_patrol.png", 'dailies\\daily_patrol_new.png', image_name='daily_patrol')
daily_vanya_ale = MultiVision("dailies\\daily_vanya_ale.png", 'dailies\\daily_vanya_ale_new.png', image_name='daily_vanya_ale')
