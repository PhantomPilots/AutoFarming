...
class IFighter(abc.ABC):
    ...
    def play_cards(self, hand_of_cards: list[Card] | None = None, **kwargs):
    ...
    def _move_card(self, origin_card: Card, target_card: Card, window_location: np.ndarray):
        ...
        drag_im(origin_point, target_point, window_location=window_location, sleep_after_click=0.1, drag_duration=0.2)
        time.sleep(0.2)
