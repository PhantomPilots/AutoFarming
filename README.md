...
1. Download the repository in a trusted location, either by downloading manually or by using GIT: `git pull https://github.com/PhantomPilots/AutoFarming.git`.
